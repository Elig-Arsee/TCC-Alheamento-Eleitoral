...
correlação <- psych::pairs.panels(Data2018[8:11])
...
modi_ai <- mlogit::mlogit(Q12P2.B_Atitude_Turno_2 ~ 1 | Q11_Satisfacao_Democracia +
                            P3.4_Avaliacao_Governo_Federal +
...
modi_ai2 <- mlogit::mlogit(Q12P2.B_Atitude_Turno_2 ~ 1 | Q11_Satisfacao_Democracia +
                             P3.4_Avaliacao_Governo_Federal +
                             P3.7_Avaliacao_Partidos_Politicos +
                             P3.8_Avaliacao_Congresso_Nacional_Senado_CamaraDeputados,
                           data = Data2018,
...
modi_ai3 <- mlogit::mlogit(Q12P2.B_Atitude_Turno_2 ~ 1 | Q11_Satisfacao_Democracia +
                             P3.4_Avaliacao_Governo_Federal +
                             P3.7_Avaliacao_Partidos_Politicos +
                             P3.8_Avaliacao_Congresso_Nacional_Senado_CamaraDeputados,
                           data = Data2018,
...
# Modelo Satisfação
mod_sat <- multinom(Q12P2.B_Atitude_Turno_2 ~ Q11_Satisfacao_Democracia +
                      P3.4_Avaliacao_Governo_Federal +
                      P3.7_Avaliacao_Partidos_Politicos +
                      P3.8_Avaliacao_Congresso_Nacional_Senado_CamaraDeputados,
